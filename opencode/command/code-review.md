...
Review uncommitted changes by default. If no uncommitted changes, review the last commit. If the user provides a pull request number or link, use CLI tool (gh) to fetch it and then perform your review.
